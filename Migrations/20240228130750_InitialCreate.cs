            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JokeId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    JokeTitle = table.Column<string>(type: "TEXT", nullable: false),
                    JokeDescription = table.Column<string>(type: "TEXT", nullable: false),
                    JokeType = table.Column<int>(type: "INTEGER", nullable: false),
                    UserId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
